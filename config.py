...
class Config(object):
    ...
    BLOB_CONNECTION_STRING = os.environ.get('BLOB_CONNECTION_STRING') or 'ENTER_CONNECTION_STRING_HERE'
    ...
    REDIRECT_PATH = "/oauth2/v2.0/token"  # Used to form an absolute URL; must match to app's redirect_uri set in AAD
